...
# execute via : 
#   tcsh -xef proc.CAT007.RST.non-linear.tcsh |& tee output.proc.CAT007.RST.non-linear.tcsh
...
set output_dir = PROC.RST.non-linear
...
auto_warp.py -base MNI_caez_N27+tlrc -input CAT007.ANAT_ns+orig \
...
3dbucket -prefix CAT007.ANAT_ns awpy/CAT007.ANAT_ns.aw.nii
...
foreach run ( $runs )
    ...
    3dNwarpApply -master CAT007.ANAT_ns+tlrc -dxyz 3                \
...
#
# afni_proc.py -subj_id CAT007 -script proc.CAT007.RST.non-linear.tcsh       \
#     -out_dir PROC.RST.non-linear -dsets RST/CAT007.RST+orig -copy_anat     \
...
#     -volreg_align_e2a -volreg_tlrc_warp -tlrc_NL_warp -align_opts_aea      \
#     -skullstrip_opts -shrink_fac_bot_lim 0.8 -no_pushout -tlrc_base        \
#     MNI_caez_N27+tlrc -mask_segment_anat yes -blur_filter -1blur_fwhm      \
#     -blur_size 6 -regress_opts_3dD -jobs 6 -regress_censor_outliers 0.1    \
